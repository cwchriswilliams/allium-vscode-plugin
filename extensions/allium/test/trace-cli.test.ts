...
test("trace CLI json includes exact test file and line hits", () => {
  const dir = fs.mkdtempSync(path.join(os.tmpdir(), "allium-trace-"));
  fs.mkdirSync(path.join(dir, "specs"), { recursive: true });
  fs.mkdirSync(path.join(dir, "tests"), { recursive: true });
  fs.writeFileSync(
...
test("trace CLI reads defaults from allium.config.json", () => {
  const dir = fs.mkdtempSync(path.join(os.tmpdir(), "allium-trace-"));
  fs.mkdirSync(path.join(dir, "specs"), { recursive: true });
  fs.mkdirSync(path.join(dir, "tests"), { recursive: true });
  fs.writeFileSync(
...
test("trace CLI semantic mode maps rule hits from quoted literals", () => {
  const dir = fs.mkdtempSync(path.join(os.tmpdir(), "allium-trace-"));
  fs.mkdirSync(path.join(dir, "specs"), { recursive: true });
  fs.mkdirSync(path.join(dir, "tests"), { recursive: true });
  fs.writeFileSync(
